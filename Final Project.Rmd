...
Fatal risk could include personal chracters (age, sex, position), time factors (season, time of the day)$^2$, driving behaviours (drunk, safety measurement) and environmental dectription (location). Each of these factors could be a potential threat to our safety and they could also work interactively. Here we fit a logistic model$^2$ to figure out their causality and relationship.

Once a serious traffic accident happens, the response and rescue from hospitals would be the last hope to save the live. Response time and arriving time at the scene$^3$ would be the first concern to construct a survival model.
...
Actually, the analysis is umcomplete to some extent. Fisrt of all, it is better to include all accident data over 5 years in Maryland to make inference about fatality rate. Secondly, more factors could be included in the model to improve the accuracy of the predictive model.
...
[3]. Wu, Jingshu, Matthew Craig, and Anders Longthorne. "Updated Estimates of Potential Traffic Fatality Reductions With Automatic Collision Notification." 24th International Technical Conference on the Enhanced Safety of Vehicles (ESV). No. 15-0269. 2015.
